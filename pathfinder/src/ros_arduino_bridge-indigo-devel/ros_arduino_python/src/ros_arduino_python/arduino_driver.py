...
class Arduino:
    ...
    def __init__(self, port="/dev/ttyUSB0", baudrate=9600, timeout=2, motors_reversed=False):
...
if __name__ == "__main__":
    ...
    myArduino = Arduino(port=portName, baudrate=baudRate, timeout=2)
    myArduino.connect()
    ...
    print("Connection test successful.", end=' ')
